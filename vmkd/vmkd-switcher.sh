...
if echo $devices | grep OSMC; then
  ...
  wait
  cp /home/osmc/features/vmkd-switcher/lxde-rc-on.xml /home/osmc/.config/openbox/
  wait
  ...
  rm /home/osmc/.config/openbox/lxde-rc.xml
  wait
  cp /home/osmc/features/vmkd-switcher/lxde-rc-off.xml /home/osmc/.config/openbox/
  wait
  cd /home/osmc/.config/openbox/
  wait
